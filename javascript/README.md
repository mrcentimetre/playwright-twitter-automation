# Twitter Automation - JavaScript/Node.js

Automate Twitter posts using Playwright and Node.js.
...
```bash
node tweet.js cookies "Your tweet message here"
```
...
node tweet.js post "Your message here"
```

## Files

- `tweet.js` - Main automation script
- `twitter_cookies.json` - Exported cookies (you create this)
- `twitter-auth.json` - Saved session from manual login (auto-generated)
...
⚠️ **Never commit** `twitter_cookies.json` or `twitter-auth.json` to Git - they contain your login credentials!
